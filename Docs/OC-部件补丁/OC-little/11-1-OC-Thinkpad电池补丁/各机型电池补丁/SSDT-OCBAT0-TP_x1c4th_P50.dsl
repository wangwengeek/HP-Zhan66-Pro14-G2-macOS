            ...
            Else
            {
                ...
                If (Arg2)
                {
                    ...
                    Store (Local7, Local0)
                        ...
                        If ((Arg0 == Zero))
                        {
                            Arg3 [Zero] = \_SB.PCI0.LPC.EC.B0I0
                            Arg3 [One] = \_SB.PCI0.LPC.EC.B0I1
                            Arg3 [0x02] = \_SB.PCI0.LPC.EC.B0I2
                            Arg3 [0x03] = \_SB.PCI0.LPC.EC.B0I3
                        }
                        Else
                        {
                            Arg3 [Zero] = \_SB.PCI0.LPC.EC.B1I0
                            Arg3 [One] = \_SB.PCI0.LPC.EC.B1I1
                            Arg3 [0x02] = \_SB.PCI0.LPC.EC.B1I2
                            Arg3 [0x03] = \_SB.PCI0.LPC.EC.B1I3
                        }
                            }
                            Else
                            {
