// battery
// In config ACPI, GACW renamed XACW
// Find:     47 41 43 57 00
// Replace:  58 41 43 57 00
//
// In config ACPI, GBAW renamed XBAW
// Find:     47 42 41 57 00
...
//
// In config ACPI, SBTC renamed YBTC
// Find:     53 42 54 43 03
...
DefinitionBlock ("", "SSDT", 2, "ACDT", "BAT0", 0x00000000)
{
    ...
    External (_SB.PCI0.LPCB.EC0.NBST, PkgObj)
    External (_SB.PCI0.LPCB.EC0.NBTI, PkgObj)
    External (_SB.PCI0.LPCB.EC0.NDBS, PkgObj)
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
            ...
            Method (BTIF, 1, Serialized)
            {
              If (_OSI ("Darwin"))
              {
                ...
                NBST [Arg0] = \_SB.PCI0.LPCB.EC0.NDBS
                Acquire (BTMX, 0xFFFF)
                NGBT |= Local7
                Release (BTMX)
                Acquire (ECMX, 0xFFFF)
              ...
              If (_OSI ("Darwin"))
              {
                ...
                If (\_SB.PCI0.LPCB.EC0.ECRG)
                {
                    If ((BATP & (One << Arg0)))
                    {
                        ...
                        DerefOf (Local0 [One]) [One] = (B1B2 (BDC1, 
                            BDC2) >> 0x08)
                        DerefOf (Local0 [One]) [0x02] = B1B2 (BFC1, BFC2)
                        DerefOf (Local0 [One]) [0x03] = (B1B2 (BFC1, 
                            BFC2) >> 0x08)
                        DerefOf (Local0 [One]) [0x04] = B1B2 (BRC1, BRC2)
                        DerefOf (Local0 [One]) [0x05] = (B1B2 (BRC1, 
                            BRC2) >> 0x08)
                        DerefOf (Local0 [One]) [0x06] = B1B2 (BME1, BME2)
                        DerefOf (Local0 [One]) [0x07] = (B1B2 (BME1, 
                            BME2) >> 0x08)
                        DerefOf (Local0 [One]) [0x08] = B1B2 (BCC1, BCC2)
                        DerefOf (Local0 [One]) [0x09] = (B1B2 (BCC1, 
                            BCC2) >> 0x08)
                        ...
                        DerefOf (Local0 [One]) [0x0D] = (B1B2 (BPV1, 
                            BPV2) >> 0x08)
                        ...
                        DerefOf (Local0 [One]) [0x11] = (B1B2 (BDV1, 
                            BDV2) >> 0x08)
                        DerefOf (Local0 [One]) [0x12] = B1B2 (BST1, BST2)
                        DerefOf (Local0 [One]) [0x13] = (B1B2 (BST1, 
                            BST2) >> 0x08)
                        DerefOf (Local0 [One]) [0x14] = B1B2 (BCV1, BCV2)
                        DerefOf (Local0 [One]) [0x15] = (B1B2 (BCV1, 
                            BCV2) >> 0x08)
                        DerefOf (Local0 [One]) [0x16] = B1B2 (BC01, BC02)
                        DerefOf (Local0 [One]) [0x17] = (B1B2 (BC01, 
                            BC02) >> 0x08)
                        DerefOf (Local0 [One]) [0x18] = B1B2 (BC03, BC04)
                        DerefOf (Local0 [One]) [0x19] = (B1B2 (BC03, 
                            BC04) >> 0x08)
                        DerefOf (Local0 [One]) [0x1A] = B1B2 (BC05, BC06)
                        DerefOf (Local0 [One]) [0x1B] = (B1B2 (BC05, 
                            BC06) >> 0x08)
